    ...
    <body class="g-sidenav-show  bg-gray-200">
        <aside
            ...
            <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white " href="{{ route('dashboard.administrativo.administrativo') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white active bg-gradient-primary"
                            href="{{ route('dashboard.administrativo.alunosAdm') }}">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 tabelaFunc">
                                ...
                                <a class="btnAdd" href="{{ route('dashboard.administrativo.formAluno') }}">Adicionar Aluno</a>
                            </div>
                        </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">Turma</p>
                                                <p class="text-xs text-secondary mb-0">01</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm bg-gradient-success">Ativado</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">Turma</p>
                                                <p class="text-xs text-secondary mb-0">04</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm bg-gradient-success">Ativado</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">Turma</p>
                                                <p class="text-xs text-secondary mb-0">03</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm bg-gradient-success">Ativado</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">Turma</p>
                                                <p class="text-xs text-secondary mb-0">02</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">

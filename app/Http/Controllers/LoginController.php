    ...
    public function autenticar(Request $request)
    {
        ...
        // $tipo = 'aluno';
            ...
            session([
                ...
                'tipo_usuario' => 'Aluno',
                'email' => $tipoUsuario->emailResponsavel,
           ...
           return redirect()->route('dashboard.aluno.aluno');
            ...
            if($tipoUsuario->tipoFuncionario =='administrativo'){
               ...
               return redirect()->route('dashboard.administrativo.administrativo');



            } elseif ($tipoUsuario->tipoFuncionario == 'educador'){
                // dd($tipoUsuario);
                // $tipo = 'instrutor';
           ...
           return redirect()->route('dashboard.educador.educador');
